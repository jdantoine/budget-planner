...
namespace JDBudgetPlanner.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> LoginGuestSuperUser()
        {
            ...
            //sign in user
            var user = await UserManager.FindByNameAsync("superguest@jdbudget.com");
            var result = await SignInManager.PasswordSignInAsync("superguest@jdbudget.com", "Access@1", false, shouldLockout: false);
        ...
        public async Task<ActionResult> LoginGuest()
        {
            ...
            // sign in user
            var user = await UserManager.FindByNameAsync("guest@jdbudget.com");
            var result = await SignInManager.PasswordSignInAsync("guest@jdbudget.com", "Access@1", false, shouldLockout: false);

            return RedirectToAction("JoinHousehold", "Household");
        }
